        ...
        >
          <Grid col={10}>
            <div className="utbildning-list">
              ...
              >
                {' '}
                <div className="date">27/5/2019- 28/6/2019</div> <br /> Nti
                skolan - Development 1
                <br />
                Stockholm
              </CardText>
              <CardText
              ...
              >
                {' '}
                <div className="date">20/8/2018-15/3/2019</div> <br /> C3L
                skola(SFX-IT) - Swedish for Developers - Stockholm
              </CardText>
              <CardText
                style={{
                  fontSize: '20px',
              ...
              >
                {' '}
                <div className="date">2/7/2018-17/8/2018</div> <br />{' '}
                Folkuniversitetet - Swedish (B2 + C1 )
                <br />
                Stockholm
              </CardText>
              <CardText
              ...
              >
                {' '}
                <div className="date">2008-2013</div> <br /> Technological
                Education Institute of Central Macedonia -
